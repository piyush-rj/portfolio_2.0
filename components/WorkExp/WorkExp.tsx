...
export default function WorkExp() {
    ...
    return (
        <motion.div
            ...
            className="relative rounded-[24px] sm:rounded-[40px] overflow-hidden w-full"
        >
            ...
            <motion.div
                ...
                transition={{ duration: 0.7, ease: "easeOut" }}
                className={`absolute inset-0 z-0 shadow-2xl ${theme == "dark" ? "bg-gradient-to-br from-[#072423] to-black" : "bg-gradient-to-b from-[#0e464463] to-neutral-300"}`}
            />

            {/* Main Content */}
            <div className={`relative z-10 backdrop-blur-xl flex flex-col lg:flex-row items-center justify-between w-full rounded-[24px] sm:rounded-[40px] gap-6 sm:gap-8 lg:gap-10 px-4 sm:px-6 lg:px-30 py-6 sm:py-8 lg:py-25 font-sans ${theme == "dark" ? "border border-[#181818] text-white" : "border border-neutral-400 text-black"}`}>
                {/* Text Section */}
                <div className="text-center lg:text-left w-full lg:w-auto">
                    <h2 className={`text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight ${theme == "dark" ? "text-neutral-100" : "text-black"}`}>
                        Work Experience
                    </h2>
                    <p className={`mt-2 text-base sm:text-lg lg:text-[18px] max-w-sm mx-auto lg:mx-0 ${theme == "dark" ? "text-neutral-400" : "text-neutral-800"}`}>
                        Projects that reflect my contributions and full-stack expertise.
                    </p>
                </div>
                ...
                <div className="w-full lg:w-auto lg:mt-0">
                    <Card
                        ...
                        imagePath="/wallpaperHeavenLogo.png"
                        duration="Jun-Jul 25"
